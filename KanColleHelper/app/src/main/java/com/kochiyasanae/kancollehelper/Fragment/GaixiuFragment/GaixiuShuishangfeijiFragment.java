 ...
 */
public class GaixiuShuishangfeijiFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String sqlchaxun =  "select leibie1,leibie2,mingcheng,gaixiujian,guanzhuxinpin from gaixiu where leibie1 = '水上飞机'  ";
