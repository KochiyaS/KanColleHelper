package com.kochiyasanae.kancollehelper.Fragment.GaixiuFragment;
 ...
 */
public class GaixiuDuikongzhuangbeiFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String sqlchaxun =  "select leibie1,leibie2,mingcheng,gaixiujian,guanzhuxinpin from gaixiu where leibie1 = '对空装备'  ";
