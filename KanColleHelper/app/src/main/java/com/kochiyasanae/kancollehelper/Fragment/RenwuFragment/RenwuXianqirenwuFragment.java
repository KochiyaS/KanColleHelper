 ...
 */
public class RenwuXianqirenwuFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        sqlrenwuchaxun = "select bianhao,leibie1,leibie2,mingcheng,miaoshu,qitaneirong from renwu where leibie1 = '123'  ";
