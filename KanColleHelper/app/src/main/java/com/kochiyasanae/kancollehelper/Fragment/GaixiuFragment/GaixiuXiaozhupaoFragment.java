 ...
 */
public class GaixiuXiaozhupaoFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String sqlchaxun =  "select leibie1,leibie2,mingcheng,gaixiujian,guanzhuxinpin from gaixiu where leibie2 like '小口径%'  ";
