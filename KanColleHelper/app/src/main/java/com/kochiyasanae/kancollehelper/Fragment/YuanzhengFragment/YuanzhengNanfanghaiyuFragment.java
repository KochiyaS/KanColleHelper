 ...
 */
public class YuanzhengNanfanghaiyuFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        sqlyuanzhengchaxun = "select bianhao,haiyu,mingcheng,haoshi1,nandu from yuanzheng where haiyu = '南方海域'  ";
