...
public class RecyclerViewYuanzhengAdapter extends RecyclerView.Adapter<RecyclerViewYuanzhengAdapter.ViewHolder> implements View.OnClickListener,View.OnLongClickListener {
    ...
    public RecyclerViewYuanzhengAdapter(String[] datas) {
        this.datas = datas;
    }
...
//第二步，传入数值
    public RecyclerViewYuanzhengAdapter(List<String> yuanzhengbianhao, List<String> yuanzhengmingcheng, List<String> yuanzhengshijian, List<String> yuanzhenghaiyu, List<String> yuanzhengnandu){
    ...
    public RecyclerViewYuanzhengAdapter(Context mContext) {
        this.mContext = mContext;
    }

//第三步，创造viewholder
    @Override
    public RecyclerViewYuanzhengAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view =
