 ...
 */
public class YuanzhengBeifanghaiyuFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        sqlyuanzhengchaxun = "select bianhao,haiyu,mingcheng,haoshi1,nandu from yuanzheng where haiyu = '北方海域'  ";
