...
public class RenwuXilieFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String renwuxilie = sharedPreferences.getString("renwuxilie", "周常系列任务");
       ...
       mAdapter.setOnItemClickListener(new RecyclerViewRenwuXilieAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, final String data) {
                ...
                {
                    final String[] renwufenlei = {getString(R.string.richang),getString(R.string.zhouchang),getString(R.string.yuechang),getString(R.string.xinshou),getString(R.string.jiaban)};
